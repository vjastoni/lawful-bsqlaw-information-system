  ...
  return (
    <div className="shadow-md w-full sticky top-0 left-0 z-[1] text-shadow-md font-bold">
      <div className="md:flex items-center justify-between bg-maroon py-4 md:px-10 px-7">
        ...
        <ul
          className={`md:flex md:items-center lg:justify-end md:justify-between lg:gap-10 md:gap-6 gap-16 font-Lora text-2xl md:text-xs lg:py-0 md:py-8 pb-12 absolute lg:static bg-maroon md:z-auto z-[-1] left-0 w-full md:w-full md:pl-0 pl-9 lg:pr-0 md:pr-4 transition-all duration-500 ease-in-out ${
